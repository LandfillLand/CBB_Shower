      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 w-full relative z-10 -translate-y-2 sm:-translate-y-3 lg:-translate-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="lg:pr-6">
            ...
            <Reveal as="a" href="https://aaaneko.neo-life.wenturc.com" target="_blank" rel="noreferrer" className="group inline-flex items-center gap-1 mt-3 text-sm font-medium brand-text hover:opacity-90 transition" delay={220}>
          ...
          {loading ? (
            ...
            <>
              ...
              >
                ...
                {/** 更多插件卡片 */}
                <Card key="more-card" className="group p-5 sm:p-6 cursor-pointer card-surface" onClick={() => window.open('https://aaaneko.neo-life.wenturc.com', '_blank', 'noopener,noreferrer')}>
                  <div className="relative z-10">
